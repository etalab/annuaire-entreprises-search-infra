...
AIRFLOW_DAG_NAME = "insert-elk-sirene"
AIRFLOW_ENV = Variable.get("ENV", "dev")
AIRFLOW_URL = Variable.get("AIRFLOW_URL", "")
AIRFLOW_DATA_DIR = AIRFLOW_DAG_TMP + AIRFLOW_DAG_FOLDER + AIRFLOW_DAG_NAME + "/data/"
SIRENE_DATABASE_LOCATION = AIRFLOW_DATA_DIR + "sirene.db"
DIRIG_DATABASE_LOCATION = AIRFLOW_DATA_DIR + "rne.db"
